<x-forum.layouts.home>
    <div class="max-w-3xl mx-auto mt-10">
        <h1 class="text-3xl font-bold mb-6">Nueva pregunta</h1>
        ...
        <form action="{{ route('questions.store') }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" name="title" value="{{ old('title') }}" required
                       ...
                       placeholder="Ejemplo: ¿Cómo funciona la herencia en PHP?">
            </div>
            ...
            <div>
                ...
                <textarea name="content" rows="6" required
                          class="w-full rounded border border-gray-300 text-black p-2"
                          placeholder="Describe tu duda aquí...">{{ old('content') }}</textarea>
            </div>
